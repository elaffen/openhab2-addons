 ...
 */
public class DashboardTileTemplate implements DashboardTile {
    private String name;
    private String url;
    private String overlay;
    private String imageUrl;

    private DashboardTileTemplate(DashboardTileBuilder builder) {
    ...
    public static class DashboardTileBuilder {
        ...
        public DashboardTileTemplate build() {
            return new DashboardTileTemplate(this);
        }
    }
}
